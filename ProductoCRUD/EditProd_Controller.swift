...
class EditProd_Controller: UIViewController, UITextFieldDelegate {
    ...
    func preCargarDatos() {
        ...
        nombreTextField.text = prod.nombre
        precioTextField.text = String(prod.precio)
        stockTextField.text = String(prod.stock)
        categoriaTextField.text = prod.categoria
    }
